...
function showUniqueSkills() {
    ...
    document.getElementById('result').textContent = `Unique skills: ${uniqueSkills.join(', ')}`;
}

function showTotalBalance() {
    const totalBalance = getTotalBalance(users);
    document.getElementById('result').textContent = `Total balance of users with exactly two friends and under 30 years old: $${totalBalance}`;
}
